...
if (backend_count EQUAL 0)
  message(FATAL_ERROR
    ...
    "Set exactly one of: MLN_WITH_OPENGL, MLN_WITH_METAL, MLN_WITH_VULKAN, MLN_WITH_WEBGPU, or MLN_WITH_SKIA.")
elseif (backend_count GREATER 1)
  message(FATAL_ERROR
    "Multiple rendering backends selected. "
    "Please enable only one of: MLN_WITH_OPENGL, MLN_WITH_METAL, MLN_WITH_VULKAN, MLN_WITH_WEBGPU, or MLN_WITH_SKIA.")
endif()
