...
#
# When MLN_LINUX_STATIC_DEPS is ON, this file downloads and builds
# system-level dependencies from source with -fPIC so they can be linked
# into the final shared library without text relocation errors.
#
# This reduces runtime dependencies on system library versions (ICU,
# libpng, zlib, etc.), improving portability across Linux distros.
...
# against its own TLS backend (OpenSSL/GnuTLS/NSS) dynamically. We don't
# assume which backend curl uses.
...
# These are regular variables (not cache) since this file is include()'d
# from linux.cmake and shares its scope.
